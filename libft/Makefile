...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2019/09/11 17:00:49 by glychest          #+#    #+#              #
#    Updated: 2019/09/21 20:53:30 by glychest         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
%.o: %.c $(HEADERS)
	@gcc -Wall -Wextra -Werror -I $(HEADERS) -c $<
